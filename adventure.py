...
answer = input("You are a on a dirt road, it has come to an end and you can go left or right. Which way would you like to go? ").lower()
...
if answer == "left":
    ...
    if answer == "back":
        ...
        print("You cross the bridge and meet stranger. Do you talk to them(yes/no)? .")
